...
Modified by: Frederik Leksell
www: http://frederik.se
Version: 1.0
...
class SRM_Safe_Redirect_Manager {
	...
	public $default_max_redirects = 500;
	...
	*/
	...
	public function action_redirect_chain_alert() {
		...
		if ( apply_filters( 'srm_check_for_possible_redirect_loops', false ) ) {
			if ( $this->check_for_possible_redirect_loops() ) {
				?>
					<div class="updated">
						<p><?php _e( 'Warning: Possible redirect loops and/or chains have been created.', 'safe-redirect-manager' ); ?></p>
					</div>
				<?php
				}
			...
			?>
				...
				<div class="error">
					<p><?php _e( 'Error: You have reached the maximum allowable number of redirects', 'safe-redirect-manager' ); ?></p>
				</div>
			<?php
			}
		}
	...
	public function action_register_post_types() {
		$redirect_labels = array(
			...
			'parent_item_colon' => '',
			'menu_name' => __( 'Redirect Manager', 'safe-redirect-manager' )
		);
	...
	?>
		...
		<p>
			...
			<em><?php _e( "</br>301 Moved Permanently </br>302 Found</br>303 See Other</br>307 Temporary Redirect</br>403 Forbidden</br>404 Not Found", 'safe-redirect-manager' ); ?></em>
		</p>
	<?php
	}
