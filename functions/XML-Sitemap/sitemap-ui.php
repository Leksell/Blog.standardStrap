	...
	function HtmlShowOptionsPage() {
		...
		<div class="wrap" id="sm_div">
			<form method="post" action="<?php echo $this->sg->GetBackLink() ?>">
				<h2><?php _e('XML Sitemap Generator') ?> </h2>
				<?php
				if(function_exists("wp_update_plugins") && (!defined('SM_NO_UPDATE') || SM_NO_UPDATE == true)) {
				...
				<?php endif; ?>
					...
					<?php $this->HtmlPrintBoxHeader('sm_basic_options',__('Basic Options', 'sitemap')); ?>
						...
						<b><?php _e('Sitemap files:','sitemap'); ?></b> 
						<ul>
							<li>
								<label for="sm_b_xml">
						...
						<b><?php _e('Building mode:','sitemap'); ?></b> 
						<ul>
							<li>
						...
						<b><?php _e('Update notification:','sitemap'); ?></b> 
						<ul>
							<li>
						...
						<b><?php _e('Advanced options:','sitemap'); ?></b> 
						<ul>
							<li>
